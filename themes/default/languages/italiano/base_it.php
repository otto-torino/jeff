...
<p>Jeff ha una struttura modulare, pertanto è facilmente estendibile. Si possono creare nuovi plugin o moduli da installare nel sistema.</p>",
	...
	"yes"=>"si",
	"no"=>"no",
	"MenuEditVoices"=>"Modifica voci di menu.",
	"MenuInsertVoice"=>"Inserimento nuova voce di menu.",
	"MenuInsertVoiceUnder"=>"Inserimento nuova voce di menu sotto '%s'.",
	...
	"AppPrefInfo"=>"Gestione delle opzioni base dell'applicazione.",
	"AppPrefEdit"=>"Modifica delle opzioni base dell'applicazione.",
	"DatetimePref"=>"Opzioni data e ora",
	"DatetimePrefInfo"=>"Gestione delle opzioni data e ora, timezone e formati. Per i timezone fare riferimento a <a href='http://www.php.net/manual/en/timezones.php'>questa pagina</a>.",
	"DatetimePrefEdit"=>"Modifica opzioni data e ora",
    "LanguagesPref" => "Gestione delle lingue del sistema, una sola lingua deve essere impostata come principale.",
    "LanguagesPrefEdit" => "Modifica lingue.",
    "LanguagesPrefInsert" => "Inserimento nuova lingua di sistema.",
	"Languages"=>"Lingue",
	"Users"=>"Utenti",
	"UsersPrefInfo"=>"Gestione utenti di sistema.",
	"UsersPrefEdit"=>"Modifica utenti",
	"UsersPrefInsert"=>"Inserimento nuovo utente di sistema.",
	"Groups"=>"Gruppi",
	"EditGroup"=>"Modifica gruppo",
	"Permissions"=>"Permessi",
	"Aspect"=>"Aspetto",
	"Layout"=>"Layout",
	"HomeAdmin"=>"Amministrazione",
	"Logout"=>"Logout",
	"all"=>"tutti",
	"none"=>"nessuno",
	"label"=>"etichetta",
	...
	"ModernThemeDescription"=>"Tema moderno, responsive, usa bootstrap e font-awesome",
