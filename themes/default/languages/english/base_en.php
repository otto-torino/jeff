...
<p>Jeff has a modular structure which make it easily extensible.</p>",
	...
	"yes"=>"yes",
	"no"=>"no",
	"MenuEditVoices"=>"Menu voices modification.",
	"MenuInsertVoice"=>"Insertion of a new menu voice under '%s'.",
	...
	"AppPrefInfo"=>"management of application preferences.",
	"AppPrefEdit"=>"Modification of application preferences.",
	"DatetimePref"=>"Datetime preferences",
	"DatetimePrefInfo"=>"management of date and time options, timezones and formats. To see available timezones please read <a href='http://www.php.net/manual/en/timezones.php'>this page</a>.",
	"DatetimePrefEdit"=>"Modification of date and time options.",
    "LanguagesPref" => "Management of system languages. Only one language should be marked as main.",
    "LanguagesPrefEdit" => "Modification of languages.",
    "LanguagesPrefInsert" => "New system language insertion.",
	"Languages"=>"Languages",
	"Users"=>"Users",
	"UsersPrefInfo"=>"Management of system users.",
	"UsersPrefEdit"=>"Users modification.",
	"UsersPrefInsert"=>"Insertion of a new system user.",
	"Groups"=>"Groups",
	...
	"ModernThemeDescription"=>"Responsive theme, uses bootstrap and font-awesome.",
