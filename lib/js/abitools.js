...
var layerWindow = new Class({
	...
	locateContainer: function() {
		...
		this.top = (this.dopt && typeof this.dopt.top != undefined) ? this.dopt.top < 0 ? 0 : this.dopt.top : elementCoord 
			? elementCoord.top 
			: (getViewport().cY-this.container.getCoordinates().height/2);
		this.left = (this.dopt && typeof this.dopt.left != undefined) ? this.dopt.left < 0 ? 0 : this.dopt.left : elementCoord 
			? elementCoord.left 
