...
var DatePicker = new Class({
	...
	unformat: function(t, format, date) {
		...
		// necessary because of 31/30 days months. If changing month before day maybe the month is shifted forward if the starting date is a 31 month
		if(!date) {
